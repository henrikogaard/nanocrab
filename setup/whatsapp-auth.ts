...
<html><head><title>NanoCrab - WhatsApp Auth</title>
...
<script>
  var startKey = 'nanocrab_qr_start';
...
<html><head><title>NanoCrab - Connected!</title>
<style>
...
<script>localStorage.removeItem('nanocrab_qr_start');</script>
</body></html>`;
