...
| Container egress governance                | `#/audit`, `#/security`                           | `/api/egress`, `/api/runtime-audit/proof-matrix`, `/api/runtime-audit/export/tamper-evident`               | Default-deny network topology, destination-bound egress decisions, container hardening, audit export, and proof matrix    | Shipped — host proof remains per `#218`–`#222`                   |
