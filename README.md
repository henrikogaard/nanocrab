...
- **Scheduled Briefings** — Report Studio can create daily or weekly briefing schedules backed by scheduled tasks. Briefings use the reports provider profile, journal/memory sources, selected output formats, and keep external delivery behind approval.
