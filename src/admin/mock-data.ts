      ...
      boardCards: [
        {
          ...
          stage: {
            ...
            kind: 'implement',
            name: 'Implement',
            requiredEvidence: ['tests', 'pushed_branch', 'open_pr'],
          },
          agent: {
            id: 'agent_1',
            handle: 'forge',
      ...
      snapshots: [
        {
          ...
          issueNumber: 42,
          title: 'Add dashboard mock mode',
          githubFieldOptionId: 'opt_implement',
          githubFieldUpdatedAt: '2026-07-12T12:00:00Z',
      ...
      pipelines: [
        {
          pipeline: {
            ...
            githubProjectId: 'proj_1',
            workflowFieldId: 'field_1',
            repositoryScopes: ['henrikogaard/nanocrab'],
            enabled: true,
            syncCursor: null,
            lastSyncedAt: null,
          ...
          stages: [
            {
              id: 'stage_0',
              pipelineId: 'pipeline_1',
              githubFieldOptionId: 'opt_planning',
            ...
            },
            {
              id: 'stage_2',
              pipelineId: 'pipeline_1',
              githubFieldOptionId: 'opt_review',
      ...
      decisions: [
        {
          ...
          stageId: 'stage_1',
          runId: null,
          proposedStageId: 'stage_2',
          proposedAgentProfileId: 'agent_2',
